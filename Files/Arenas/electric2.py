...
class ElectricArena(Arenas.SuperArena):
    "The grass is NOT greener on the other side of this fence!  Bots fight on a platform surrounded by an electric fence and suspended over a death pit that will turn your bot to slag."
    name = "Electric Arena 2"
    preview = "electric2/dm_electric_preview2.bmp"
    game_types = ['DEATHMATCH', 'BATTLE ROYAL', 'TABLETOP']
    extent = (-15, 15, 15, -15)
    ...
    def __init__(self):
        Arenas.SuperArena.__init__(self, "Arenas/electric2/electric2.gmf")
